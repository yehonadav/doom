namespace CodeImp.DoomBuilder.Controls
{
	partial class ScriptEditorPanel
	{
		...
		private void InitializeComponent()
		{
			...
			this.scripticons.Images.SetKeyName(26, "GroupUnknown.png");
			this.scripticons.Images.SetKeyName(27, "GroupACS.png");
			this.scripticons.Images.SetKeyName(28, "GroupMODELDEF.png");
			this.scripticons.Images.SetKeyName(29, "GroupDECORATE.png");
			this.scripticons.Images.SetKeyName(30, "GroupGLDEFS.png");
			this.scripticons.Images.SetKeyName(31, "GroupSNDSEQ.png");
			this.scripticons.Images.SetKeyName(32, "GroupMAPINFO.png");
			this.scripticons.Images.SetKeyName(33, "GroupVOXELDEF.png");
			this.scripticons.Images.SetKeyName(34, "GroupTEXTURES.png");
			this.scripticons.Images.SetKeyName(35, "GroupANIMDEFS.png");
			this.scripticons.Images.SetKeyName(36, "GroupREVERBS.png");
			this.scripticons.Images.SetKeyName(37, "GroupTERRAIN.png");
			this.scripticons.Images.SetKeyName(38, "GroupX11.png");
			this.scripticons.Images.SetKeyName(39, "GroupCVARINFO.png");
			this.scripticons.Images.SetKeyName(40, "GroupSNDINFO.png");
			this.scripticons.Images.SetKeyName(41, "GroupLOCKDEFS.png");
			this.scripticons.Images.SetKeyName(42, "GroupMENUDEF.png");
			this.scripticons.Images.SetKeyName(43, "GroupSBARINFO.png");
			this.scripticons.Images.SetKeyName(44, "GroupUSDF.png");
			this.scripticons.Images.SetKeyName(45, "GroupGAMEINFO.png");
			this.scripticons.Images.SetKeyName(46, "GroupKEYCONF.png");
			this.scripticons.Images.SetKeyName(47, "GroupFONTDEFS.png");
			this.scripticons.Images.SetKeyName(48, "GroupOpen.png");
			this.scripticons.Images.SetKeyName(49, "OpenGroupACS.png");
			this.scripticons.Images.SetKeyName(50, "OpenGroupMODELDEF.png");
			this.scripticons.Images.SetKeyName(51, "OpenGroupDECORATE.png");
			this.scripticons.Images.SetKeyName(52, "OpenGroupGLDEFS.png");
			this.scripticons.Images.SetKeyName(53, "OpenGroupSNDSEQ.png");
			this.scripticons.Images.SetKeyName(54, "OpenGroupMAPINFO.png");
			this.scripticons.Images.SetKeyName(55, "OpenGroupVOXELDEF.png");
			this.scripticons.Images.SetKeyName(56, "OpenGroupTEXTURES.png");
			this.scripticons.Images.SetKeyName(57, "OpenGroupANIMDEFS.png");
			this.scripticons.Images.SetKeyName(58, "OpenGroupREVERBS.png");
			this.scripticons.Images.SetKeyName(59, "OpenGroupTERRAIN.png");
			this.scripticons.Images.SetKeyName(60, "OpenGroupX11.png");
			this.scripticons.Images.SetKeyName(61, "OpenGroupCVARINFO.png");
			this.scripticons.Images.SetKeyName(62, "OpenGroupSNDINFO.png");
			this.scripticons.Images.SetKeyName(63, "OpenGroupLOCKDEFS.png");
			this.scripticons.Images.SetKeyName(64, "OpenGroupMENUDEF.png");
			this.scripticons.Images.SetKeyName(65, "OpenGroupSBARINFO.png");
			this.scripticons.Images.SetKeyName(66, "OpenGroupUSDF.png");
			this.scripticons.Images.SetKeyName(67, "OpenGroupGAMEINFO.png");
			this.scripticons.Images.SetKeyName(68, "OpenGroupKEYCONF.png");
			this.scripticons.Images.SetKeyName(69, "OpenGroupFONTDEFS.png");
			// 
			// projecticons
			// 
